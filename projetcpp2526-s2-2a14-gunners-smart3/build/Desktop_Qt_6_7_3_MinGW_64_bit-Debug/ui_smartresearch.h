...
public:
    ...
    QLineEdit *rechPub_2;
    QPushButton *recherchePub_2;
    QPushButton *statPub_2;
    QPushButton *SuppPub_2;
    QPushButton *quitterPub_2;
    QTableView *tableViewPub_2;
    QPushButton *expoPub_2;
    QPushButton *triePub_2;
    QGroupBox *groupBox_6;
    QWidget *formLayoutWidget_2;
    QFormLayout *formLayout_3;
    QLabel *label_12;
    QLineEdit *Id_utilisateur_2;
    QLabel *label_13;
    QLineEdit *titrePub_2;
    QLabel *label_14;
    QLineEdit *auteurPub_2;
    QLabel *label_15;
    QLineEdit *abstractPub_2;
...
"        "));
        ...
        groupBox_5 = new QGroupBox(tab_Paiement);
        groupBox_5->setObjectName("groupBox_5");
        groupBox_5->setGeometry(QRect(470, 0, 711, 541));
        groupBox_5->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 36, 168);\n"
"border: #A8D3F0;\n"
"/* Style pour tous les GroupBox */\n"
"QGroupBox {\n"
"    border: 2px solid #2c3e50; /* Couleur de la bordure */\n"
...
"    padding: 0 10px;\n"
"}"));
        rechPub_2 = new QLineEdit(groupBox_5);
        rechPub_2->setObjectName("rechPub_2");
        rechPub_2->setGeometry(QRect(10, 40, 161, 26));
        rechPub_2->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));
        recherchePub_2 = new QPushButton(groupBox_5);
        recherchePub_2->setObjectName("recherchePub_2");
        recherchePub_2->setGeometry(QRect(180, 38, 150, 31));
        recherchePub_2->setStyleSheet(QString::fromUtf8("background-color: rgb(16, 151, 255);\n"
""));
        statPub_2 = new QPushButton(groupBox_5);
        statPub_2->setObjectName("statPub_2");
        statPub_2->setGeometry(QRect(560, 440, 150, 31));
        statPub_2->setStyleSheet(QString::fromUtf8("background-color: rgb(16, 151, 255);\n"
""));
        SuppPub_2 = new QPushButton(groupBox_5);
        SuppPub_2->setObjectName("SuppPub_2");
        SuppPub_2->setGeometry(QRect(40, 440, 150, 41));
        SuppPub_2->setStyleSheet(QString::fromUtf8("background-color: rgb(209, 14, 0);"));
        quitterPub_2 = new QPushButton(groupBox_5);
        quitterPub_2->setObjectName("quitterPub_2");
        quitterPub_2->setGeometry(QRect(480, 480, 150, 31));
        quitterPub_2->setStyleSheet(QString::fromUtf8("background-color: rgb(209, 14, 0);\n"
""));
        tableViewPub_2 = new QTableView(groupBox_5);
        tableViewPub_2->setObjectName("tableViewPub_2");
        tableViewPub_2->setGeometry(QRect(10, 80, 691, 341));
        tableViewPub_2->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
""));
        expoPub_2 = new QPushButton(groupBox_5);
        expoPub_2->setObjectName("expoPub_2");
        expoPub_2->setGeometry(QRect(390, 440, 150, 31));
        expoPub_2->setStyleSheet(QString::fromUtf8("background-color: rgb(16, 151, 255);\n"
""));
        triePub_2 = new QPushButton(groupBox_5);
        triePub_2->setObjectName("triePub_2");
        triePub_2->setGeometry(QRect(560, 40, 150, 31));
        triePub_2->setStyleSheet(QString::fromUtf8("background-color: rgb(16, 151, 255);\n"
""));
        groupBox_6 = new QGroupBox(tab_Paiement);
        groupBox_6->setObjectName("groupBox_6");
        groupBox_6->setGeometry(QRect(10, 0, 451, 541));
        groupBox_6->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 36, 168);\n"
"border: #A8D3F0;"));
        formLayoutWidget_2 = new QWidget(groupBox_6);
        formLayoutWidget_2->setObjectName("formLayoutWidget_2");
        formLayoutWidget_2->setGeometry(QRect(20, 40, 411, 335));
        ...
        Id_utilisateur_2 = new QLineEdit(formLayoutWidget_2);
        Id_utilisateur_2->setObjectName("Id_utilisateur_2");
        Id_utilisateur_2->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));

        formLayout_3->setWidget(0, QFormLayout::FieldRole, Id_utilisateur_2);
        ...
        titrePub_2 = new QLineEdit(formLayoutWidget_2);
        titrePub_2->setObjectName("titrePub_2");
        titrePub_2->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));

        formLayout_3->setWidget(1, QFormLayout::FieldRole, titrePub_2);
        ...
        auteurPub_2 = new QLineEdit(formLayoutWidget_2);
        auteurPub_2->setObjectName("auteurPub_2");
        auteurPub_2->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));

        formLayout_3->setWidget(2, QFormLayout::FieldRole, auteurPub_2);
        ...
        abstractPub_2 = new QLineEdit(formLayoutWidget_2);
        abstractPub_2->setObjectName("abstractPub_2");
        abstractPub_2->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
""));

        formLayout_3->setWidget(3, QFormLayout::FieldRole, abstractPub_2);

        formLayout_4 = new QFormLayout();
        formLayout_4->setObjectName("formLayout_4");
        radioButton_Admin_6 = new QRadioButton(formLayoutWidget_2);
        ...
        formLayout_4->setWidget(0, QFormLayout::FieldRole, radioButton_Admin_6);

        radioButton_Admin_7 = new QRadioButton(formLayoutWidget_2);
        ...
        formLayout_4->setWidget(2, QFormLayout::FieldRole, radioButton_Admin_7);

        radioButton_Admin_5 = new QRadioButton(formLayoutWidget_2);
        ...
        formLayout_4->setWidget(1, QFormLayout::FieldRole, radioButton_Admin_5);
        ...
        datePub_2 = new QDateEdit(formLayoutWidget_2);
        datePub_2->setObjectName("datePub_2");
        datePub_2->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));

        formLayout_3->setWidget(5, QFormLayout::FieldRole, datePub_2);
        ...
        abstractPub_3 = new QLineEdit(formLayoutWidget_2);
        abstractPub_3->setObjectName("abstractPub_3");
        abstractPub_3->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
""));

        formLayout_3->setWidget(6, QFormLayout::FieldRole, abstractPub_3);

        enregistrer_2 = new QPushButton(groupBox_6);
        enregistrer_2->setObjectName("enregistrer_2");
        enregistrer_2->setGeometry(QRect(40, 400, 150, 41));
        enregistrer_2->setMinimumSize(QSize(0, 0));
        enregistrer_2->setStyleSheet(QString::fromUtf8("background-color: rgb(16, 151, 255);\n"
""));
        modif_2 = new QPushButton(groupBox_6);
        modif_2->setObjectName("modif_2");
        modif_2->setGeometry(QRect(240, 400, 150, 41));
        modif_2->setStyleSheet(QString::fromUtf8("background-color: rgb(16, 151, 255);\n"
""));
        annuler_2 = new QPushButton(groupBox_6);
        annuler_2->setObjectName("annuler_2");
        annuler_2->setGeometry(QRect(150, 460, 150, 41));
        annuler_2->setStyleSheet(QString::fromUtf8("background-color: rgb(209, 14, 0);\n"
""));
...
""));
        ...
        menubar->setGeometry(QRect(0, 0, 1488, 25));
...
"Conf\303\251rence", nullptr));
        ...
        recherchePub_2->setText(QCoreApplication::translate("SmartResearch", "Recherche", nullptr));
        statPub_2->setText(QCoreApplication::translate("SmartResearch", "Statistique ", nullptr));
        SuppPub_2->setText(QCoreApplication::translate("SmartResearch", "Supprimer", nullptr));
        quitterPub_2->setText(QCoreApplication::translate("SmartResearch", "Quitter", nullptr));
        expoPub_2->setText(QCoreApplication::translate("SmartResearch", "Exportation", nullptr));
        triePub_2->setText(QCoreApplication::translate("SmartResearch", "Trie", nullptr));
        groupBox_6->setTitle(QString());
        label_12->setText(QCoreApplication::translate("SmartResearch", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">ID_Paiement</span></p></body></html>", nullptr));
        label_13->setText(QCoreApplication::translate("SmartResearch", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Type_Frais</span></p></body></html>", nullptr));
        label_14->setText(QCoreApplication::translate("SmartResearch", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Montant</span></p></body></html>", nullptr));
        label_15->setText(QCoreApplication::translate("SmartResearch", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Devise</span></p></body></html>", nullptr));
        radioButton_Admin_6->setText(QCoreApplication::translate("SmartResearch", "En Attente", nullptr));
        radioButton_Admin_7->setText(QCoreApplication::translate("SmartResearch", "Annul\303\251", nullptr));
        radioButton_Admin_5->setText(QCoreApplication::translate("SmartResearch", "Paye", nullptr));
        label_19->setText(QCoreApplication::translate("SmartResearch", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Date_Paiement</span></p><p><br/></p></body></html>", nullptr));
        label_16->setText(QCoreApplication::translate("SmartResearch", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Statue Paiement</span></p></body></html>", nullptr));
        label_17->setText(QCoreApplication::translate("SmartResearch", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:700; color:#ffffff;\">Mode_Paiement</span></p></body></html>", nullptr));
        enregistrer_2->setText(QCoreApplication::translate("SmartResearch", "Enregistrer", nullptr));
        modif_2->setText(QCoreApplication::translate("SmartResearch", "Modifier", nullptr));
