...
{
    QSqlQuery query;
    query.prepare("INSERT INTO TABLE_UTILISATEUR (ID_UTILISATEUR, NOM_UTILISATEUR, EMAIL_UTILISATEUR, MDP_UTILISATEUR, ROLE_UTILISATEUR, NUM_UTILISATEUR, INSTITUTION_UTILISATEUR, PRENOM_UTILISATEUR) "
...
QSqlQueryModel * Utilisateur::afficher()
{
    ...
    model->setQuery("SELECT ID_UTILISATEUR, NOM_UTILISATEUR, PRENOM_UTILISATEUR, EMAIL_UTILISATEUR, MDP_UTILISATEUR, ROLE_UTILISATEUR, NUM_UTILISATEUR, INSTITUTION_UTILISATEUR FROM TABLE_UTILISATEUR ORDER BY ID_UTILISATEUR ASC");
...
bool Utilisateur::modifier(int id)
{
    ...
    query.prepare("UPDATE TABLE_UTILISATEUR SET ID_UTILISATEUR=:newId, NOM_UTILISATEUR=:nom, EMAIL_UTILISATEUR=:email, MDP_UTILISATEUR=:mdp, ROLE_UTILISATEUR=:role, NUM_UTILISATEUR=:num, INSTITUTION_UTILISATEUR=:inst, PRENOM_UTILISATEUR=:prenom WHERE ID_UTILISATEUR=:oldId");
