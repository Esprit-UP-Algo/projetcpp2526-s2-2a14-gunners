...
public:
    ...
    QPushButton *pushButton_pdfclient_2;
    ...
    QLineEdit *lineEdit_ModePaiement;
...
"}"));
        ...
        groupBox_4->setGeometry(QRect(30, 30, 1431, 771));
...
"}"));
        ...
        formLayoutWidget_Utilisateur->setGeometry(QRect(20, 40, 451, 271));
...
""));
        ...
        modif_3->setGeometry(QRect(40, 470, 150, 41));
...
""));
        ...
        annulerajout_client_3->setGeometry(QRect(270, 420, 71, 61));
...
"}"));
        ...
        pushButton_supprimer_client_2->setGeometry(QRect(60, 440, 61, 51));
...
""));
        ...
        label_20 = new QLabel(groupBox_Session_List_6);
        label_20->setObjectName("label_20");
        label_20->setGeometry(QRect(450, 420, 191, 51));
...
""));
        ...
        quitterSession_7->setGeometry(QRect(480, 480, 131, 41));
...
"\n"
""));
        pushButton_pdfclient_2 = new QPushButton(groupBox_Session_List_6);
        pushButton_pdfclient_2->setObjectName("pushButton_pdfclient_2");
        pushButton_pdfclient_2->setGeometry(QRect(670, 440, 41, 51));
        pushButton_pdfclient_2->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: rgb(16, 151, 255);\n"
"   /* normal state */\n"
"    color: white;\n"
"    border: none;\n"
...
""));
        ...
        pushButton_pdfclient_2->setIcon(icon2);
        ...
        pushButton_recherche_4->setGeometry(QRect(190, 30, 121, 41));
...
""));
        ...
        comboBox_11->setGeometry(QRect(550, 40, 141, 26));
        QPalette palette;
        QBrush brush(QColor(0, 0, 0, 255));
        brush.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::WindowText, brush);
        QBrush brush1(QColor(216, 226, 233, 255));
        ...
        comboBox_11->setStyleSheet(QString::fromUtf8("background-color: #D8E2E9;\n"
"QPushButton {\n"
"    /* La couleur de fond (bleu pro) */\n"
"    background-color: #2c3e50; \n"
"    \n"
...
"}\n"
""));
        pushButton_recherche_3->setIcon(icon3);
...
"border: #A8D3F0;"));
        ...
        formLayoutWidget_Session->setGeometry(QRect(20, 50, 478, 331));
...
"QGroupBox::title { subcontrol-origin: margin; subcontrol-position: top center; padding: 0 10px; }"));
        ...
        lineEdit_Type = new QLineEdit(formLayoutWidget_Utilisateur_2);
        lineEdit_Type->setObjectName("lineEdit_Type");
        lineEdit_Type->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));

        formLayout_Utilisateur_4->setWidget(1, QFormLayout::FieldRole, lineEdit_Type);
        ...
        lineEdit_ModePaiement = new QLineEdit(formLayoutWidget_Utilisateur_2);
        lineEdit_ModePaiement->setObjectName("lineEdit_ModePaiement");
        lineEdit_ModePaiement->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));

        formLayout_Utilisateur_4->setWidget(4, QFormLayout::FieldRole, lineEdit_ModePaiement);
        ...
        formLayout_Utilisateur_4->setWidget(6, QFormLayout::LabelRole, label_num_4);
        ...
        lineEdit_Devise = new QLineEdit(formLayoutWidget_Utilisateur_2);
        lineEdit_Devise->setObjectName("lineEdit_Devise");
        lineEdit_Devise->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));

        formLayout_Utilisateur_4->setWidget(3, QFormLayout::FieldRole, lineEdit_Devise);

        btn_Annuler_paiement = new QPushButton(groupBox_Paiement_Form);
        btn_Annuler_paiement->setObjectName("btn_Annuler_paiement");
        btn_Annuler_paiement->setGeometry(QRect(250, 420, 71, 61));
...
""));
        ...
        btn_Modifier_paiement->setGeometry(QRect(30, 460, 150, 41));
...
"}"));
        ...
        comboBoxPaiement->setGeometry(QRect(550, 40, 141, 26));
        QPalette palette5;
        ...
        comboBoxPaiement->setPalette(palette5);
        comboBoxPaiement->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));
        ...
        pushButton_supprimer_paiement->setGeometry(QRect(80, 450, 61, 51));
...
""));
        ...
        expoSession_2->setGeometry(QRect(450, 430, 191, 51));
...
"Conf\303\251rence", nullptr));
        ...
        label_20->setText(QCoreApplication::translate("SmartResearch", "Exporter format PDF", nullptr));
        quitterSession_7->setText(QCoreApplication::translate("SmartResearch", "Quitter", nullptr));
        pushButton_pdfclient_2->setText(QString());
